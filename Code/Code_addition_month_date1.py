...
clf = linear_model.SGDRegressor(loss= 'squared_loss', max_iter= 1000, tol = 5.0, n_iter= 100)
...
result.to_csv('/Users/mayur/Documents/GitHub/Taxi_Fare/processed_files/result_04.csv', 
              index= False)
