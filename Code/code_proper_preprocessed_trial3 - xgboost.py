...
Added peak hours, night and working day flag - 9.05
"""
...
def XGBoost(X_train,X_test,y_train,y_test):
    ...
    return xgb.train(params={'objective':'reg:linear','eval_metric':'rmse',
                    ...
                    early_stopping_rounds=25,evals=[(dtest,'test')],)
...
result.to_csv('/Users/mayur/Documents/GitHub/New_York_Taxi_Fare/processed_files/result_16.csv', 
              index= False)
